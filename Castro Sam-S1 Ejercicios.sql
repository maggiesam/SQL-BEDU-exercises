...
-- 5. Dentro de la tabla employees, obtén el apellido, nombre y puesto 
-- de todos los empleados que tengan el puesto Sales Rep. 
SELECT lastName, firstName, jobTitle
FROM employees
WHERE jobTitle = 'Sales Rep';

-- 6. Dentro de la tabla employees, obtén el apellido, nombre, puesto y código de oficina 
-- de todos los empleados que tengan el puesto Sales Rep y código de oficina 1. 
SELECT lastName, firstName, jobTitle, officeCode
FROM employees
WHERE jobTitle = 'Sales Rep'
AND officeCode = 1;

-- 7. Dentro de la tabla employees, obtén el apellido, nombre, puesto y código de oficina 
-- de todos los empleados que tengan el puesto Sales Rep o código de oficina 1. 
SELECT lastName, firstName, jobTitle, officeCode
FROM employees
WHERE jobTitle = 'Sales Rep'
OR officeCode = 1;
...
-- los empleados cuyo código de oficina sea menor o igual 4. 
SELECT lastName, firstName, officeCode
FROM employees
WHERE officeCode <= 4;

-- 12. Dentro de la tabla customers, obtén el nombre, país y estado de todos los clientes cuyo 
-- país sea USA y cuyo estado sea CA.
DESCRIBE customers;
...
-- 14. Dentro de la tabla customers, obtén el nombre y país de todos los clientes cuyo país sea 
-- USA o France. 
...
-- 15. Dentro de la tabla customers, obtén el nombre y país de todos los clientes cuyo país sea 
-- USA o France y cuyo límite de crédito sea mayor a 100000. 
SELECT customerName, country
FROM customers
WHERE (country = 'USA'
	OR country = 'France')
...
-- 17. Dentro de la tabla offices, obtén el código de la oficina, ciudad, teléfono y país de aquellas 
-- oficinas que se no encuentren en USA o France. 
SELECT officeCode, city, phone, country
FROM offices
...
-- 19. Dentro de la tabla customers, obtén el apellido de contacto y nombre de cada cliente y ordena 
...
-- 20. Dentro de la tabla customers, obtén el apellido de contacto y nombre de cada cliente y ordena 
...
-- crédito de los cinco clientes con el límite de crédito más bajo diferente de 0. 
SELECT customerNumber, customerName, creditLimit
FROM customers
WHERE creditLimit != 0
